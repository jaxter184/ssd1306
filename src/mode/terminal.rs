    ...
    DI: DisplayInterface,
{
    ...
    pub fn clear(&mut self) -> Result<(), TerminalModeError<DI>> {
        ...
        self.properties
            .set_draw_area((display_x_offset, display_y_offset), (display_width + display_x_offset, display_height + display_y_offset))
//            .set_draw_area((0,0), (display_width, display_height))
    ...
    fn reset_pos(&mut self) -> Result<(), TerminalModeError<DI>> {
        let (display_x_offset, display_y_offset) = self.properties.display_offset;
        self.properties.set_column(display_x_offset).terminal_err()?;
